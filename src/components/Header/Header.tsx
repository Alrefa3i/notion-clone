...
const Nav = ({ user }: { user: any }) => {
  ...
  const [userState, setUser] = useState(user || null);
  return (
    <header
      className="p-4
      flex
  ...
  "
    >
      ...
      >
        <Image src={Logo} alt="Cypress Logo" width={70} />
        <span
      ...
      <NavigationMenu className="hidden md:block text-base">
      ...
      >
        {!userState && (
          <Link href={"/login"}>
            <Button variant="outline" className=" py-2 px-4 hidden sm:block">
              Login
            </Button>
          </Link>
        )}
        {!userState ? (
          <Link href="/signup">
            <Button variant="default" className="whitespace-nowrap py-2 px-4">
              Sign Up
            </Button>
          </Link>
        ) : (
          <Link href="/logout">
            <Button
              variant="default"
              className="whitespace-nowrap py-2 px-4 text-red-600"
            >
              Logout
            </Button>
          </Link>
